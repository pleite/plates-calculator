# Plates — weight plate calculator

A single-file, installable web app (PWA) for calculating barbell load.

Open `index.html` in any browser, or install it as a home-screen app on iOS / Android.

## How it works
- Tap plates to toggle them on/off (one of each, no stacking).
